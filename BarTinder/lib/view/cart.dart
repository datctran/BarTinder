...
class BottomBar extends StatelessWidget {
  final List<InventoryItem> foodItems;
  ...
  Container totalAmount(List<InventoryItem> foodItems) {
    return Container(
      margin: EdgeInsets.only(right: 10),
  ...
  String returnTotalAmount(List<InventoryItem> foodItems) {
...
class _DragTargetWidgetState extends State<DragTargetWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    var dragTarget = DragTarget<InventoryItem>(
      onAccept: (InventoryItem item) {
        currentItem = item;
        colorBloc.setColor(Colors.white);
        widget.bloc.remove(currentItem);
      },
      onWillAccept: (InventoryItem item) {
        colorBloc.setColor(Colors.red);
        return true;
      },
      onLeave: (Object inventoryItem) {
        colorBloc.setColor(Colors.white);        
      },
